...
<head>
	...
	<meta name="description" content="15年ぶりエンジニア復帰中年 一から学習し直し最初の
...
<body>
    ...
    <h3>
        <a href="./samples/samples-index.html">各種サンプルプログラム</a>
    </h3>
    <hr>
    <p>
        <h4>
...
-->
    <footer style='position:absolute; bottom:0; width:100%; height:60px; margin:0px'>
        ...
        <address style="display: inline">
            <a>itachip38@gmail.com</a>
        </address>
        <img src="images/tambourine.gif">
    </footer>
</body>
</html>
